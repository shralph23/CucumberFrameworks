...
public class SubmnLinkSvcSubmn
{
   private long idSubmn;   
   private String cdStdzdPptyPstlMtch;            
   private AddressRqst addressRqst;
   ...
   public SubmnLinkSvcSubmn() {
   }
   
   public SubmnLinkSvcSubmn( long idSubmn, 
      ...
      this.addressRqst = new AddressRqst();
      this.addressRqst.setFipsStateAlphaCode( FIPSStateAlphaCode.valueOf( cdStdzdPptyFipsStAlpha ) );
   ...
   public AddressRqst getAddressRqst()
   {
      return addressRqst;
   }

   public void setAddressRqst( AddressRqst addressRqst )
   {
      this.addressRqst = addressRqst;
   }
   ...
   public String getCityNameMtch()
   {
      return cityNameMtch;
   }

   public void setCityNameMtch( String cityNameMtch )
   {
      this.cityNameMtch = cityNameMtch;
   }
   ...
   {
      return "SubmissionCacheData [idSubmn=" + idSubmn + ", idPmlSubmnLink=" + idPmlSubmnLink + ", dttmSubmnRqst=" + dttmSubmnRqst + ", nameSrceSyst=" + nameSrceSyst + ", namePrtyRoleTypeMtch="
            + namePrtyRoleTypeMtch + ", idPrtyMtch=" + idPrtyMtch + ", nameStdzdPptyCityMtch=" + nameStdzdPptyCityMtch + ", cdStdzdPptyFipsStAlpha=" + addressRqst.getFipsStateAlphaCodeString() + ", idApprslDocFileMtch="
            + idApprslDocFileMtch + ", idLendrLoanMtch=" + idLendrLoanMtch + ", idLoanUwCaseMtch=" + idLoanUwCaseMtch + ", idMersMinMtch=" + idMersMinMtch + ", nameAusTypeMtch=" + nameAusTypeMtch
            + ", cdStdzdPptyPstlMtch=" + cdStdzdPptyPstlMtch + ", textStdzdPptyAddrLiMtch=" + textStdzdPptyAddrLiMtch + ", textStdzdPptyAddrLiCnctntd=" + textStdzdPptyAddrLiCnctntd + ", dttmCreate="
            + dttmCreate + ", dttmLstUpdt=" + dttmLstUpdt + ", idCreate=" + idCreate + ", idLstUpdt=" + idLstUpdt + "]";
   }
   
   @Override
   public String toString()
   {
      return "SubmnLinkSvcSubmn [idSubmn=" + idSubmn + ", cdStdzdPptyPstlMtch=" + cdStdzdPptyPstlMtch + ", addressRqst=" + addressRqst + ", cdSubmnLinkSvcActnLgcy=" + cdSubmnLinkSvcActnLgcy
            + ", cntMdlSvcSubmn=" + cntMdlSvcSubmn + ", dttmSubmnRqst=" + dttmSubmnRqst + ", idApprslDocFile=" + idApprslDocFile + ", idApprslDocFileMtch=" + idApprslDocFileMtch + ", idCndtMtchRslt="
            + idCndtMtchRslt + ", idDcsnMtchSubmn=" + idDcsnMtchSubmn + ", idDoc=" + idDoc + ", idFmLoan=" + idFmLoan + ", idLendrLoan=" + idLendrLoan + ", idLendrLoanMtch=" + idLendrLoanMtch
            + ", idLoanUwCase=" + idLoanUwCase + ", idLoanUwCaseMtch=" + idLoanUwCaseMtch + ", idMersMin=" + idMersMin + ", idMersMinMtch=" + idMersMinMtch + ", idModelRqst=" + idModelRqst
            + ", idMtchMdlVrsn=" + idMtchMdlVrsn + ", idPmlSrceSubmnTrans=" + idPmlSrceSubmnTrans + ", idPrty=" + idPrty + ", idPrtyMtch=" + idPrtyMtch + ", idSrceSubmn=" + idSrceSubmn
            + ", idPmlSubmnLink=" + idPmlSubmnLink + ", idPmlSubmnLinkOrigl=" + idPmlSubmnLinkOrigl + ", idSubmnRqst=" + idSubmnRqst + ", idValidtnRuleVrsn=" + idValidtnRuleVrsn + ", indMtchErr="
            + indMtchErr + ", indRqstErr=" + indRqstErr + ", indSubmnErr=" + indSubmnErr + ", nameAusType=" + nameAusType + ", nameAusTypeMtch=" + nameAusTypeMtch + ", nameCndtMtchType="
            + nameCndtMtchType + ", namePrtyRoleType=" + namePrtyRoleType + ", namePrtyRoleTypeMtch=" + namePrtyRoleTypeMtch + ", nameSrceSyst=" + nameSrceSyst + ", nameSrceSystMtch="
            + nameSrceSystMtch + ", nameSubmtngSystShort=" + nameSubmtngSystShort + ", nameStdzdPptyCityMtch=" + nameStdzdPptyCityMtch + ", textStdzdPptyAddrLiMtch=" + textStdzdPptyAddrLiMtch
            + ", textStdzdPptyAddrLiCnctntd=" + textStdzdPptyAddrLiCnctntd + ", cityNameMtch=" + cityNameMtch + ", dttmRqstPrcsgStart=" + dttmRqstPrcsgStart + ", dttmRqstPrcsgEnd=" + dttmRqstPrcsgEnd
            + ", dttmCreate=" + dttmCreate + ", dttmLstUpdt=" + dttmLstUpdt + ", idCreate=" + idCreate + ", idLstUpdt=" + idLstUpdt + "]";
   }
